...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('products')->where('id', '>=', 37)->delete();
        DB::table('products')->upsert([
            ...
            ['id' => 14, 'category_id' => 22, 'product_code' => 'PRD-ACC-PA-01', 'name' => 'Tempat Surat & Menu Holder Batu Kali', 'material_type' => 'batu_kali', 'dimension_spec' => 'D: 15-20 cm, Tebal: 6-8 cm', 'finishing_type' => 'Smooth Grafir Custom', 'ready_stock' => 25, 'safety_stock' => 5, 'standard_cogs' => 45000.00, 'selling_price' => 85000.00, 'image_path' => 'images/products/tempat-surat-menu-batu-kali.webp', 'created_at' => $now, 'updated_at' => $now],
            ['id' => 15, 'category_id' => 22, 'product_code' => 'PRD-ACC-PA-02', 'name' => 'Dispenser Sabun & Shampo Batu Kali Natural (Set 2 Pcs)', 'material_type' => 'batu_kali', 'dimension_spec' => 'T: 18 cm, D: 8-10 cm (Set 2 Pcs)', 'finishing_type' => 'Kulit Alami x Pump Chrome', 'ready_stock' => 20, 'safety_stock' => 5, 'standard_cogs' => 90000.00, 'selling_price' => 165000.00, 'image_path' => 'images/products/dispenser-sabun-shampo-batu-kali.webp', 'created_at' => $now, 'updated_at' => $now],
            ['id' => 16, 'category_id' => 22, 'product_code' => 'PRD-ACC-PA-03', 'name' => 'Dispenser Sabun & Shampo Marmer Silinder (Set 2 Pcs)', 'material_type' => 'marmer', 'dimension_spec' => 'T: 18 cm, D: 7 cm (Set 2 Pcs)', 'finishing_type' => 'Full Polished Hi-Glossy', 'ready_stock' => 15, 'safety_stock' => 4, 'standard_cogs' => 100000.00, 'selling_price' => 185000.00, 'image_path' => 'images/products/dispenser-sabun-shampo-marmer.webp', 'created_at' => $now, 'updated_at' => $now],
            ['id' => 17, 'category_id' => 22, 'product_code' => 'PRD-ACC-PA-04', 'name' => 'Set Perlengkapan Kamar Mandi Marmer Mewah (Set 5 Pcs)', 'material_type' => 'marmer', 'dimension_spec' => 'Dispenser T: 18 cm, Tumbler, Soap Dish, Nampan Marmer', 'finishing_type' => 'Hotel Grade Polished', 'ready_stock' => 10, 'safety_stock' => 2, 'standard_cogs' => 250000.00, 'selling_price' => 425000.00, 'image_path' => 'images/products/set-aksesoris-kamar-mandi-marmer-krem.webp', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id' => 28, 'category_id' => 16, 'product_code' => 'PRD-MRM-018', 'name' => 'Wastafel Marmer Full Polish Cream', 'material_type' => 'marmer', 'dimension_spec' => 'D: 45 cm, T: 12 cm', 'finishing_type' => 'Hi-Glossy', 'ready_stock' => 15, 'safety_stock' => 5, 'standard_cogs' => 200000.00, 'selling_price' => 350000.00, 'image_path' => 'images/products/wastafel-marmer-full-polish-cream-1787847011.png', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id' => 34, 'category_id' => 16, 'product_code' => 'PRD-MRM-024', 'name' => 'Wastafel Onix Full Polish', 'material_type' => 'marmer', 'dimension_spec' => 'D: 40 cm, T: 15 cm', 'finishing_type' => 'Hi-Glossy', 'ready_stock' => 20, 'safety_stock' => 5, 'standard_cogs' => 350000.00, 'selling_price' => 500000.00, 'image_path' => 'images/products/wastafel-onix-samset-dop-1787847561.png', 'created_at' => $now, 'updated_at' => $now],

...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('products')->where('id', '>=', 20)->delete();
        DB::table('products')->upsert([
            ...
            ['id' => 15, 'category_id' => 22, 'product_code' => 'PRD-ACC-PA-02', 'name' => 'Dispenser Sabun & Shampo Batu Kali Natural (Set 2 Pcs)', 'material_type' => 'batu_kali', 'dimension_spec' => 'T: 18 cm, D: 8-10 cm (Set 2 Pcs)', 'finishing_type' => 'Kulit Batu Kali Alami x Pump Stainless Chrome', 'ready_stock' => 20, 'safety_stock' => 5, 'standard_cogs' => 90000.00, 'selling_price' => 165000.00, 'image_path' => 'images/products/dispenser-sabun-shampo-batu-kali.webp', 'created_at' => $now, 'updated_at' => $now],
            ['id' => 16, 'category_id' => 22, 'product_code' => 'PRD-ACC-PA-03', 'name' => 'Dispenser Sabun & Shampo Marmer Silinder (Set 2 Pcs)', 'material_type' => 'marmer', 'dimension_spec' => 'T: 18 cm, D: 7 cm (Set 2 Pcs)', 'finishing_type' => 'Full Polished Hi-Glossy x Pump Chrome', 'ready_stock' => 15, 'safety_stock' => 4, 'standard_cogs' => 100000.00, 'selling_price' => 185000.00, 'image_path' => 'images/products/dispenser-sabun-shampo-marmer.webp', 'created_at' => $now, 'updated_at' => $now],
            ['id' => 17, 'category_id' => 22, 'product_code' => 'PRD-ACC-PA-04', 'name' => 'Set Perlengkapan Kamar Mandi Marmer Mewah (Set 5 Pcs)', 'material_type' => 'marmer', 'dimension_spec' => 'Dispenser T: 18 cm, Tumbler, Soap Dish, Nampan Marmer', 'finishing_type' => 'Full Polished Hotel Grade x Pump Gold/Bronze', 'ready_stock' => 10, 'safety_stock' => 2, 'standard_cogs' => 250000.00, 'selling_price' => 425000.00, 'image_path' => 'images/products/set-aksesoris-kamar-mandi-marmer-krem.webp', 'created_at' => $now, 'updated_at' => $now],
            ['id' => 18, 'category_id' => 22, 'product_code' => 'PRD-MJA-PA-01', 'name' => 'Meja Kopi Batu Kali Alami (Kaki Utuh & Tusuk Sate)', 'material_type' => 'batu_kali', 'dimension_spec' => 'D: 60-80 cm, T: 65-75 cm', 'finishing_type' => 'Top Polished Hi-Glossy x Natural River Boulder Base', 'ready_stock' => 6, 'safety_stock' => 2, 'standard_cogs' => 450000.00, 'selling_price' => 850000.00, 'image_path' => 'images/products/meja-batu-kali-kopi-set.webp', 'created_at' => $now, 'updated_at' => $now],
            ['id' => 19, 'category_id' => 22, 'product_code' => 'PRD-MJA-PA-02', 'name' => 'Set Meja & Bangku Taman Batu Kali Outdoor', 'material_type' => 'batu_kali', 'dimension_spec' => 'Meja: 100x60x65 cm, Bangku: 90x35x45 cm', 'finishing_type' => 'Full Polished Flat Top x Heavy Boulder Base', 'ready_stock' => 3, 'safety_stock' => 1, 'standard_cogs' => 1200000.00, 'selling_price' => 2150000.00, 'image_path' => 'images/products/meja-kursi-taman-batu-kali-set.webp', 'created_at' => $now, 'updated_at' => $now],
